...
import DSCA.Storage.StorageGrpc.StorageImplBase;
...
public class storageServer extends StorageImplBase {
	...
	public static void main(String[] args) {
		 storageServer  storeServer= new  storageServer();

		Properties prop = storeServer.getProperties();
		
		storeServer.registerService(prop);
